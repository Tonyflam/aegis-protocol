...
npx hardhat test             # Run all 54+ tests
...
2. Ensure frontend builds: `cd frontend && npm run build`
...
- **Solidity**: Follow OpenZeppelin patterns, use NatSpec comments for public functions
- **TypeScript**: Use strict types, avoid `any`
- **Frontend**: Follow existing Tailwind + glassmorphism patterns
